...
def show_isochrone(age=8, distance=10, Fe_H=0.06, Y=0.2682, ax=None, datapath=os.getcwd(), **kwargs):
    """
    ...
    isochrones = read_isochrone_files(os.path.join(datapath, "isochrones.pkl.zip"))
